...
import 'package:medrem/src/common/convert_time.dart';
import 'package:medrem/src/global_bloc.dart';
import 'package:medrem/src/models/errors.dart';
import 'package:medrem/src/models/medicine.dart';
import 'package:medrem/src/models/medicine_type.dart';
import 'package:medrem/src/ui/homepage/homepage.dart';
import 'package:medrem/src/ui/new_entry/new_entry_bloc.dart';
import 'package:medrem/src/ui/success_screen/success_screen.dart';
...
class _SelectTimeState extends State<SelectTime> {
  TimeOfDay _time = TimeOfDay(hour: 0, minute: 00); //TimeOfDay.now();
  bool _clicked = false;
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: CustomColors.red),
          ),
        ]),
      ),
    );
